...
class _FoodCardState extends State<FoodCard> {
  ...
  Future<void> loadData() async {
    ...
    liked = likedFoodIds.contains(foodId);
    if (mounted) {
  ...
  void toggleLike() async {
    ...
    String foodId = widget.food.id;
    List<String> likedFoodIds = prefs.getStringList("likedFoodIds") ?? [];

    // Check if foodId is already in the likedFoodIds list
    ...
    // Update the liked food ids in SharedPreferences
    await prefs.setStringList("likedFoodIds", likedFoodIds);
  }
        ...
        Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) => FoodDetailsScreen(
                food: widget.food,
                user_position: widget.user_position,
              ),
            ));
      },
      child: Card(
                                ...
                                child: Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: FaIcon(
                                      ...
                                      color:
                                          liked ? scheme.primary : Colors.grey,
                                      size: 15,
                                    ),
                                  ),
                                ),
