...
class _WelcomeScreenState extends State<WelcomeScreen> {
 // AppLocalizations AppLocalizations.of(context) = AppLocalizations(Locale('en')); // Replace 'en' with the desired locale

  List<Map<String, dynamic>> getItems(BuildContext context) {
   return [
    {
      "header": AppLocalizations.of(context).translate('welcomeScreenTitle'),
      "description": AppLocalizations.of(context).translate('welcomeScreenDescription'),
      "image": "assets/img/logo.png"
    },
    {
      "header": AppLocalizations.of(context).translate('feature1Header'),
      "description": AppLocalizations.of(context).translate('feature1Description'),
      "image": "assets/img/hot_deal.png"
    },
    {
      "header": AppLocalizations.of(context).translate('feature2Header'),
      "description": AppLocalizations.of(context).translate('feature2Description'),
